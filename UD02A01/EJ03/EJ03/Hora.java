...
public class Hora
{
   ...
   public int convertirASegundos(){
       ...
       //OTRA FORMA DE ESCRIBIR EL CODIGO. Se escribiría sólo la siguiente línea de código y nos ahorraríamos el int y la 
   ...
   //declarar metodo compareTo que devuelve la diferencia entre esta hora y la que se recibe como parámetro
   ...
   public String toString(){
       ...
       //"%02d:%02d:%02d" se refiere a un numero entero, si fuera un real una F. Sirve para mostrar dos dígitos que luego se declaran
