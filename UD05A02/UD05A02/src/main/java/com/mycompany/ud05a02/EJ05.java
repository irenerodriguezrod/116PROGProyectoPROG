...
public class EJ05 {
    ...
    public static void main(String[] args) {
        ...
        double[] vectorMedias = new double[3]; // Vector con la media de cada fila
        ...
        for (int i = 0; i < matriz.length; i++) { // filas
            ...
            vectorMedias[i] = (double) suma / matriz[i].length; // Calcular la media
        }

        // Mostrar el vector con las medias
        System.out.println("Medias de las filas:");
        for (int i = 0; i < vectorMedias.length; i++) {
            System.out.printf("Media de la fila %d: %.2f%n", i, vectorMedias[i]);
        }
    }
}
